...
from robot_inference.robot_control.script.Ultrasonic import *
...
from robot_inference.robot_control.script.Line_Tracking import *
line=Line_Tracking()
def test_Infrared():
    try:
        line.test_Infrared()
...
from robot_inference.robot_control.script.servo import *
pwm=Servo()
def test_Servo():
    try:
        while True:
...
from robot_inference.robot_control.script.ADC import *
adc=Adc()
def test_Adc():
    try:
        while True:
...
from robot_inference.robot_control.script.Buzzer import *
buzzer=Buzzer()
def test_Buzzer():
    try:
        buzzer.run('1')
